...
## 当前进度
- AdSense 状态：2026-06-28 因“低价值内容”未通过，已按 WordCaseFix 经验完成内容加固，待重新提交
- 上次审计完成：待开始
- 下一步：重新提交 AdSense 审核，观察低价值内容状态是否解除
...
## 待办
- [ ] 审计全站（GA/SEO/breadcrumb/logo/favicon/about/privacy）
- [ ] 内容深化：工具页添加 How to Use / Use Cases / FAQ 模块
- [ ] 申请 AdSense


## 2026-06-28 AdSense 低价值内容修复
- 新增/重写博客指南至 27 篇，覆盖贷款、房屋、债务、储蓄、投资、税务、教育等主题。
- 新增 `methodology.html`，说明计算方法、假设、编辑标准和免责声明。
